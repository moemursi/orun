...
def _csrf_middleware():
    return ("orun.middleware.csrf.CsrfViewMiddleware" in settings.MIDDLEWARE_CLASSES or
            settings.MIDDLEWARE and "orun.middleware.csrf.CsrfViewMiddleware" in settings.MIDDLEWARE)

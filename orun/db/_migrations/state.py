...
from orun.apps import Registry, apps as global_apps
...
class ProjectState(object):
    ...
    def from_apps(cls, apps):
        ...
        app_models = {}
        for model in apps.all_models.values():
...
class StateApps(Registry):
    ...
    def __init__(self, real_apps, models, ignore_swappable=False):
        ...
        from orun.core.checks.model_checks import _check_lazy_references
            ...
            while unrendered_models:
                ...
                if len(new_unrendered_models) == len(unrendered_models):
                    raise InvalidBasesError(
                        ...
                        "https://docs.orunproject.com/en/%s/topics/migrations/#dependencies "
    ...
    def register_model(self, app_label, model):
        ...
        self.addons[app_label].models[model._meta.model_name] = model

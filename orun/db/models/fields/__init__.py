...
from orun.db.models.query_utils import DeferredAttribute, RegisterLookupMixin
...
from orun.utils.functional import Promise, cached_property, curry
...
class Field(RegisterLookupMixin):
    ...
    def __init__(self, verbose_name=None, name=None, primary_key=False,
        ...
        self.null = null
        self.blank = (blank is None and null) or blank
    ...
    def get_placeholder(self, val, compiler, conn):
    ...
    def deconstruct(self):
         ...
         * The import path of the field, including the class: orun.db.models.IntegerField
    ...
    def contribute_to_class(self, cls, name, private_only=False):
        ...
        elif self.compute or self.related_field:
    ...
    def get_attname_column(self):
        ...
        column = (self.store and (self.db_column or attname)) or None
    ...
    def formfield(self, form_class=None, choices_form_class=None, **kwargs):
        """
        Returns a orun.forms.Field instance for this database Field.
        """
    ...
    def _compute_eval(self, instance, meth):
        comp = getattr(instance.__class__, meth)
        from orun.db.models import api
        return comp(api.Record(instance))

    def _get_related_value(self, instance):
        field = self.related_field.split('.')
        obj = instance
        for f in field:
            obj = getattr(obj, f)
        return obj
...
class AutoField(Field):
    ...
    def contribute_to_class(self, cls, name, **kwargs):
        ...
        cls._meta.__class__.has_auto_field = True
        cls._meta.__class__.auto_field = self
...
class CharField(Field):
    ...
    def __init__(self, max_length=128, verbose_name=None, *args, **kwargs):
        super(CharField, self).__init__(max_length=max_length, verbose_name=verbose_name, *args, **kwargs)
...
class DecimalField(Field):
    ...
    def format_number(self, value):
        ...
        decimal places.
        """
        # Method moved to orun.db.backends.utils.
        #
        # It is preserved because it is used by the oracle backend
        # (orun.db.backends.oracle.query), and also for
...
class FilePathField(Field):
    ...
    def __init__(self, verbose_name=None, name=None, path='', match=None,
        ...
        kwargs['max_length'] = kwargs.get('max_length', 256)
...
class IPAddressField(Field):
    ...
    def __init__(self, verbose_name=None, name=None, protocol='both',
        ...
        super(IPAddressField, self).__init__(verbose_name, name, *args,
                                             **kwargs)
...
class BooleanField(Field):
    ...
    def __init__(self, verbose_name=None, *args, **kwargs):
        kwargs.setdefault('null', False)
        super(BooleanField, self).__init__(verbose_name=verbose_name, *args, **kwargs)
...
class URLField(CharField):
    ...
    def __init__(self, verbose_name=None, name=None, **kwargs):
        ...
        super(URLField, self).__init__(max_length=max_length, verbose_name=verbose_name, name=name, **kwargs)

...
from orun.core.validators import validate_image_file_extension
...
from orun.utils.encoding import force_str, force_text
...
class FileField(Field):
    ...
    def get_directory_name(self):
        warnings.warn(
            ...
            'storage. get_directory_name() will be removed in Orun 2.0.',
    ...
    def get_filename(self, filename):
        warnings.warn(
            'FileField now delegates file name and folder processing to the '
            'storage. get_filename() will be removed in Orun 2.0.',
            RemovedInOrun20Warning, stacklevel=2
        )

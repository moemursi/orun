...
from orun.db.models.expressions import F
from orun.db.models.fields import AutoField
from orun.db.models.functions import Trunc
from orun.db.models.query_utils import (
    InvalidQuery, Q, check_rel_lookup_compatibility,
)
from orun.db.models.sql.constants import CURSOR
...
class QuerySet(object):
    ...
    def __getstate__(self):
        ...
        obj_dict[ORUN_VERSION_PICKLE_KEY] = get_version()
        return obj_dict
...
class EmptyQuerySet(object, metaclass=InstanceCheckMeta):
    """

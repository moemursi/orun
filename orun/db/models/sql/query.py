...
from orun.db.models.expressions import Col, Ref
...
class RawQuery(object):
    ...
    def _execute_query(self):
        ...
        if params_type is tuple:
            ...
            params = dict((key, adapter(val)) for key, val in self.params.items())
        else:
...
class Query(object):
    ...
    def build_filter(self, filter_expr, branch_negated=False, current_negated=False,
        ...
        if field.is_relation:
            ...
            assert num_lookups > 0  # Likely a bug in Orun if this fails.

...
class DatabaseSchemaEditor(BaseDatabaseSchemaEditor):
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        # TODO recreate table with foreignkey
        self.deferred_sql = [s for s in self.deferred_sql if ' FOREIGN KEY ' not in s]
    ...
    def _remake_table(self, model, create_fields=[], delete_fields=[], alter_fields=[], override_uniques=None,
        ...
        temp_model._meta.db_table = model._meta.db_table

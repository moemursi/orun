...
class SimpleTestCase(unittest.TestCase):
        ...
        if url != expected_url:
            ...
            if url == relative_url:
                warnings.warn(
                    ...
                    "before Orun 1.9. Please update your expected URLs by "
    ...
    def assertRaisesMessage(self, expected_exception, expected_message, *args, **kwargs):
        ...
        Args:
            ...
            kwargs: Extra kwargs.
        """
        # callable_obj was a documented kwarg in Orun 1.8 and older.
        callable_obj = kwargs.pop('callable_obj', None)
        if callable_obj:
            warnings.warn(
                'The callable_obj kwarg is deprecated. Pass the callable '
                'as a positional argument instead.', RemovedInOrun20Warning
            )
        elif len(args):
            callable_obj = args[0]
            args = args[1:]

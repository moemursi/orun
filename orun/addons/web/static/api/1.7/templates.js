...
pug_html = pug_html + "\u003Cbutton class=\"btn btn-xs btn-default grid-editor-control\" ng-click=\"addItem();\" type=\"button\"\u003E";
;pug_debug_line = 3;pug_debug_filename = "src\u002Ftemplates\u002Fview.form.grid.toolbar.pug";
...
pug_html = pug_html + (pug_escape(null == (pug_interp = name) ? "" : pug_interp));
;pug_debug_line = 7;pug_debug_filename = "src\u002Ftemplates\u002Fview.form.numeric-field.pug";
pug_html = pug_html + "|number:";
;pug_debug_line = 7;pug_debug_filename = "src\u002Ftemplates\u002Fview.form.numeric-field.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = field.decimalPlaces) ? "" : pug_interp));
;pug_debug_line = 7;pug_debug_filename = "src\u002Ftemplates\u002Fview.form.numeric-field.pug";
pug_html = pug_html + ") || '";
;pug_debug_line = 7;pug_debug_filename = "src\u002Ftemplates\u002Fview.form.numeric-field.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = field.emptyText) ? "" : pug_interp));
...
var pug_has_own_property=Object.prototype.hasOwnProperty;
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;var locals_for_with = (locals || {});(function (field, inplaceEditor) {;pug_debug_line = 1;pug_debug_filename = "src\u002Ftemplates\u002Fview.list.selection-field.pug";
...
pug_html = pug_html + "\u003Cspan\u003E";
;pug_debug_line = 14;pug_debug_filename = "src\u002Ftemplates\u002Fview.list.selection-field.pug";
pug_html = pug_html + "{{ view.fields['";
;pug_debug_line = 14;pug_debug_filename = "src\u002Ftemplates\u002Fview.list.selection-field.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = field.name) ? "" : pug_interp));
;pug_debug_line = 14;pug_debug_filename = "src\u002Ftemplates\u002Fview.list.selection-field.pug";
...
pug_html = pug_html + "\u003C\u002Ftd\u003E";}.call(this,"field" in locals_for_with?locals_for_with.field:typeof field!=="undefined"?field:undefined,"inplaceEditor" in locals_for_with?locals_for_with.inplaceEditor:typeof inplaceEditor!=="undefined"?inplaceEditor:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;}
  return template;
})());
...
pug_html = pug_html + "\u003Ctable class=\"table table-hover dataTable table-responsive\"\u003E";

...
function pug_merge(e,r){if(1===arguments.length){for(var t=e[0],g=1;g<e.length;g++)t=pug_merge(t,e[g]);return t}for(var l in r)if("class"===l){var n=e[l]||[];e[l]=(Array.isArray(n)?n:[n]).concat(r[l]||[])}else if("style"===l){var n=pug_style(e[l]);n=n&&";"!==n[n.length-1]?n+";":n;var a=pug_style(r[l]);a=a&&";"!==a[a.length-1]?a+";":a,e[l]=n+a}else e[l]=r[l];return e}
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;var locals_for_with = (locals || {});(function (attrs, fieldName) {;pug_debug_line = 1;pug_debug_filename = "src\u002Ftemplates\u002Fview.form.selection-field.pug";
;pug_debug_line = 2;pug_debug_filename = "src\u002Ftemplates\u002Fview.form.selection-field.pug";
var choicesAttr = 'choice in view.fields.' + fieldName + '.choices'
;pug_debug_line = 3;pug_debug_filename = "src\u002Ftemplates\u002Fview.form.selection-field.pug";
...
;pug_debug_line = 5;pug_debug_filename = "src\u002Ftemplates\u002Fview.form.selection-field.pug";
...
pug_html = pug_html + "{{choice[1]}}\u003C\u002Foption\u003E\u003C\u002Fselect\u003E";}.call(this,"attrs" in locals_for_with?locals_for_with.attrs:typeof attrs!=="undefined"?attrs:undefined,"fieldName" in locals_for_with?locals_for_with.fieldName:typeof fieldName!=="undefined"?fieldName:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;}
  return template;
})());

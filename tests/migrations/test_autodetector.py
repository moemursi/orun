...
from orun.core.validators import RegexValidator, validate_slug
...
from orun.test import TestCase, mock
...
class AutodetectorTests(TestCase):
    ...
    @mock.patch('orun.db.migrations.questioner.MigrationQuestioner.ask_not_null_addition',
    ...
    @mock.patch('orun.db.migrations.questioner.MigrationQuestioner.ask_auto_now_add_addition')
    ...
    @mock.patch('orun.db.migrations.questioner.MigrationQuestioner.ask_not_null_alteration',
                side_effect=AssertionError("Should not have prompted for not null addition"))
